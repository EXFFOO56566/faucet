...
public class MyFirebaseMessaging extends FirebaseMessagingService {
    ...
    private static final String PAYOUT_TYPE="com.tochy.btc.PAYOUT_NOTIFICATION";
    private static final String REFER_TYPE="com.tochy.btc.REFER_NOTIFICATION";
    private static final String REVIEW_TYPE="com.tochy.btc.REVIEW_NOTIFICATION";
    int PRIVATE_MODE = 0;
